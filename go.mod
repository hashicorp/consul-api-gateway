...
require (
	...
	github.com/hashicorp/consul-server-connection-manager v0.1.0 // indirect
...
replace github.com/deepmap/oapi-codegen v1.11.0 => github.com/andrewstucki/oapi-codegen v1.10.2-0.20220901234805-2492f7f94da9
