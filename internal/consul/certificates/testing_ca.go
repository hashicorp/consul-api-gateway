...
func testCA(t testing.T, xc *pbconnectca.CARoot, keyType string, keyBits int, ttl time.Duration) *pbconnectca.CARoot {
	var result pbconnectca.CARoot
	result.Active = true
	...
	id := &uri.SpiffeIDSigning{ClusterID: TestClusterID, Domain: "consul"}
...
// SigningCert.
func TestCA(t testing.T, xc *pbconnectca.CARoot) *pbconnectca.CARoot {
...
func TestCAWithTTL(t testing.T, xc *pbconnectca.CARoot, ttl time.Duration) *pbconnectca.CARoot {
...
func TestCAWithKeyType(t testing.T, xc *pbconnectca.CARoot, keyType string, keyBits int) *pbconnectca.CARoot {
	return testCA(t, xc, keyType, keyBits, 0)
}

func testLeafWithID(t testing.T, spiffeId uri.CertURI, root *pbconnectca.CARoot, keyType string, keyBits int, expiration time.Duration) (string, string, error) {
...
func TestAgentLeaf(t testing.T, node string, datacenter string, root *pbconnectca.CARoot, expiration time.Duration) (string, string, error) {
	// Build the SPIFFE ID
	spiffeId := &uri.SpiffeIDAgent{
...
func testLeaf(t testing.T, service string, namespace string, root *pbconnectca.CARoot, keyType string, keyBits int) (string, string, error) {
	// Build the SPIFFE ID
	spiffeId := &uri.SpiffeIDService{
		Host:       fmt.Sprintf("%s.consul", TestClusterID),
		Namespace:  namespace,
		Datacenter: "dc1",
		Service:    service,
...
func TestLeaf(t testing.T, service string, root *pbconnectca.CARoot) (string, string) {
	return TestLeafWithNamespace(t, service, "default", root)
}

func TestLeafWithNamespace(t testing.T, service, namespace string, root *pbconnectca.CARoot) (string, string) {
...
// func TestMeshGatewayLeaf(t testing.T, partition string, root *pbconnectca.CARoot) (string, string) {
// 	// Build the SPIFFE ID
...
func TestCSR(t testing.T, uri uri.CertURI) (string, string) {
...
func testCAConfigSet(t testing.T, a TestAgentRPC,
	ca *pbconnectca.CARoot, keyType string, keyBits int) *pbconnectca.CARoot {
	t.Helper()
...
func TestCAConfigSet(t testing.T, a TestAgentRPC,
	ca *pbconnectca.CARoot) *pbconnectca.CARoot {
