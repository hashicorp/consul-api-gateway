...
import (
	...
	"github.com/hashicorp/consul-api-gateway/internal/consul/acl"
	"github.com/hashicorp/consul-api-gateway/internal/consul/certificates/ttlcache"
...
func backOffWait(failures uint) time.Duration {
	if failures > CacheRefreshBackoffMin {
		...
		return waitTime + utils.RandomStagger(waitTime)
	}
	return 0
}
