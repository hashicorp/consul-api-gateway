...
const gatewayCRDs = "github.com/kubernetes-sigs/gateway-api/config/crd?ref=0fbc16ba7999bfb379f3c4fdcef589d7dd333e18"
...
func CreateServiceAccount(namespace string) env.Func {
	return func(ctx context.Context, cfg *envconf.Config) (context.Context, error) {
		...
		err := backoff.Retry(func() error {
			...
			if err := cfg.Client().Resources().Get(ctx, "polar", namespace, account); err != nil {
				return err
			}
