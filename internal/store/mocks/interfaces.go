...
// RouteRemoved mocks base method.
func (m *MockListener) RouteRemoved() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "RouteRemoved")
}

// RouteRemoved indicates an expected call of RouteRemoved.
func (mr *MockListenerMockRecorder) RouteRemoved() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RouteRemoved", reflect.TypeOf((*MockListener)(nil).RouteRemoved))
}
