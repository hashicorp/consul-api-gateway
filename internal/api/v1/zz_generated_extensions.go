...
func (c *APIClient) CreateTokenForGateway(ctx context.Context, name string) (*BootstrapToken, error) {

	resp, err := c.client.CreateTokenForGatewayWithResponse(ctx, name)
	if err != nil {
		return nil, err
	}
	if resp.JSONDefault != nil {
...
func (c *APIClient) DeleteTokenForGateway(ctx context.Context, name string, id string) error {
	resp, err := c.client.DeleteTokenForGatewayWithResponse(ctx, name, id)
	if err != nil {
		return err
	}
	if resp.JSONDefault != nil && resp.JSONDefault.Code != 0 {
...
func (c *APIClient) GetTokenForGateway(ctx context.Context, name string, id string) (*BootstrapToken, error) {

	resp, err := c.client.GetTokenForGatewayWithResponse(ctx, name, id)
	if err != nil {
		return nil, err
	}
	if resp.JSONDefault != nil {
...
func (c *APIClient) CreateTokenForGatewayInNamespace(ctx context.Context, namespace string, name string) (*BootstrapToken, error) {

	resp, err := c.client.CreateTokenForGatewayInNamespaceWithResponse(ctx, namespace, name)
	if err != nil {
		return nil, err
	}
	if resp.JSONDefault != nil {
...
func (c *APIClient) DeleteTokenForGatewayInNamespace(ctx context.Context, namespace string, name string, id string) error {
	resp, err := c.client.DeleteTokenForGatewayInNamespaceWithResponse(ctx, namespace, name, id)
	if err != nil {
		return err
	}
	if resp.JSONDefault != nil && resp.JSONDefault.Code != 0 {
...
func (c *APIClient) GetTokenForGatewayInNamespace(ctx context.Context, namespace string, name string, id string) (*BootstrapToken, error) {

	resp, err := c.client.GetTokenForGatewayInNamespaceWithResponse(ctx, namespace, name, id)
	if err != nil {
		return nil, err
	}
	if resp.JSONDefault != nil {
