...
type ClientInterface interface {
	...
	// CreateTokenForGateway request
	CreateTokenForGateway(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DeleteTokenForGateway request
	DeleteTokenForGateway(ctx context.Context, name string, id string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetTokenForGateway request
	GetTokenForGateway(ctx context.Context, name string, id string, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// CreateTokenForGatewayInNamespace request
	CreateTokenForGatewayInNamespace(ctx context.Context, namespace string, name string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// DeleteTokenForGatewayInNamespace request
	DeleteTokenForGatewayInNamespace(ctx context.Context, namespace string, name string, id string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetTokenForGatewayInNamespace request
	GetTokenForGatewayInNamespace(ctx context.Context, namespace string, name string, id string, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) CreateTokenForGateway(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateTokenForGatewayRequest(c.Server, name)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeleteTokenForGateway(ctx context.Context, name string, id string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteTokenForGatewayRequest(c.Server, name, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetTokenForGateway(ctx context.Context, name string, id string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetTokenForGatewayRequest(c.Server, name, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateTokenForGatewayInNamespace(ctx context.Context, namespace string, name string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCreateTokenForGatewayInNamespaceRequest(c.Server, namespace, name)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) DeleteTokenForGatewayInNamespace(ctx context.Context, namespace string, name string, id string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteTokenForGatewayInNamespaceRequest(c.Server, namespace, name, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetTokenForGatewayInNamespace(ctx context.Context, namespace string, name string, id string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetTokenForGatewayInNamespaceRequest(c.Server, namespace, name, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewCreateTokenForGatewayRequest generates requests for CreateTokenForGateway
func NewCreateTokenForGatewayRequest(server string, name string) (*http.Request, error) {
	var err error
...
// NewDeleteTokenForGatewayRequest generates requests for DeleteTokenForGateway
func NewDeleteTokenForGatewayRequest(server string, name string, id string) (*http.Request, error) {
	var err error
...
// NewGetTokenForGatewayRequest generates requests for GetTokenForGateway
func NewGetTokenForGatewayRequest(server string, name string, id string) (*http.Request, error) {
	var err error
...
// NewCreateTokenForGatewayInNamespaceRequest generates requests for CreateTokenForGatewayInNamespace
func NewCreateTokenForGatewayInNamespaceRequest(server string, namespace string, name string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/namespaces/%s/gateways/%s/tokens", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewDeleteTokenForGatewayInNamespaceRequest generates requests for DeleteTokenForGatewayInNamespace
func NewDeleteTokenForGatewayInNamespaceRequest(server string, namespace string, name string, id string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/namespaces/%s/gateways/%s/tokens/%s", pathParam0, pathParam1, pathParam2)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetTokenForGatewayInNamespaceRequest generates requests for GetTokenForGatewayInNamespace
func NewGetTokenForGatewayInNamespaceRequest(server string, namespace string, name string, id string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// CreateTokenForGateway request
	CreateTokenForGatewayWithResponse(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*CreateTokenForGatewayResponse, error)

	// DeleteTokenForGateway request
	DeleteTokenForGatewayWithResponse(ctx context.Context, name string, id string, reqEditors ...RequestEditorFn) (*DeleteTokenForGatewayResponse, error)

	// GetTokenForGateway request
	GetTokenForGatewayWithResponse(ctx context.Context, name string, id string, reqEditors ...RequestEditorFn) (*GetTokenForGatewayResponse, error)
	...
	// CreateTokenForGatewayInNamespace request
	CreateTokenForGatewayInNamespaceWithResponse(ctx context.Context, namespace string, name string, reqEditors ...RequestEditorFn) (*CreateTokenForGatewayInNamespaceResponse, error)

	// DeleteTokenForGatewayInNamespace request
	DeleteTokenForGatewayInNamespaceWithResponse(ctx context.Context, namespace string, name string, id string, reqEditors ...RequestEditorFn) (*DeleteTokenForGatewayInNamespaceResponse, error)

	// GetTokenForGatewayInNamespace request
	GetTokenForGatewayInNamespaceWithResponse(ctx context.Context, namespace string, name string, id string, reqEditors ...RequestEditorFn) (*GetTokenForGatewayInNamespaceResponse, error)
...
type CreateTokenForGatewayResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON201      *BootstrapToken
	JSONDefault  *Error
}

// Status returns HTTPResponse.Status
func (r CreateTokenForGatewayResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CreateTokenForGatewayResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type DeleteTokenForGatewayResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSONDefault  *Error
}
...
// Status returns HTTPResponse.Status
func (r DeleteTokenForGatewayResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r DeleteTokenForGatewayResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetTokenForGatewayResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *BootstrapToken
	JSONDefault  *Error
}

// Status returns HTTPResponse.Status
func (r GetTokenForGatewayResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetTokenForGatewayResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type CreateTokenForGatewayInNamespaceResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON201      *BootstrapToken
	JSONDefault  *Error
...
// Status returns HTTPResponse.Status
func (r CreateTokenForGatewayInNamespaceResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CreateTokenForGatewayInNamespaceResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type DeleteTokenForGatewayInNamespaceResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSONDefault  *Error
}
...
// Status returns HTTPResponse.Status
func (r DeleteTokenForGatewayInNamespaceResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r DeleteTokenForGatewayInNamespaceResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetTokenForGatewayInNamespaceResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *BootstrapToken
	JSONDefault  *Error
...
// Status returns HTTPResponse.Status
func (r GetTokenForGatewayInNamespaceResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetTokenForGatewayInNamespaceResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// CreateTokenForGatewayWithResponse request returning *CreateTokenForGatewayResponse
func (c *ClientWithResponses) CreateTokenForGatewayWithResponse(ctx context.Context, name string, reqEditors ...RequestEditorFn) (*CreateTokenForGatewayResponse, error) {
	rsp, err := c.CreateTokenForGateway(ctx, name, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateTokenForGatewayResponse(rsp)
}

// DeleteTokenForGatewayWithResponse request returning *DeleteTokenForGatewayResponse
func (c *ClientWithResponses) DeleteTokenForGatewayWithResponse(ctx context.Context, name string, id string, reqEditors ...RequestEditorFn) (*DeleteTokenForGatewayResponse, error) {
	rsp, err := c.DeleteTokenForGateway(ctx, name, id, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseDeleteTokenForGatewayResponse(rsp)
}

// GetTokenForGatewayWithResponse request returning *GetTokenForGatewayResponse
func (c *ClientWithResponses) GetTokenForGatewayWithResponse(ctx context.Context, name string, id string, reqEditors ...RequestEditorFn) (*GetTokenForGatewayResponse, error) {
	rsp, err := c.GetTokenForGateway(ctx, name, id, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetTokenForGatewayResponse(rsp)
}
...
// CreateTokenForGatewayInNamespaceWithResponse request returning *CreateTokenForGatewayInNamespaceResponse
func (c *ClientWithResponses) CreateTokenForGatewayInNamespaceWithResponse(ctx context.Context, namespace string, name string, reqEditors ...RequestEditorFn) (*CreateTokenForGatewayInNamespaceResponse, error) {
	rsp, err := c.CreateTokenForGatewayInNamespace(ctx, namespace, name, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateTokenForGatewayInNamespaceResponse(rsp)
}

// DeleteTokenForGatewayInNamespaceWithResponse request returning *DeleteTokenForGatewayInNamespaceResponse
func (c *ClientWithResponses) DeleteTokenForGatewayInNamespaceWithResponse(ctx context.Context, namespace string, name string, id string, reqEditors ...RequestEditorFn) (*DeleteTokenForGatewayInNamespaceResponse, error) {
	rsp, err := c.DeleteTokenForGatewayInNamespace(ctx, namespace, name, id, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseDeleteTokenForGatewayInNamespaceResponse(rsp)
}

// GetTokenForGatewayInNamespaceWithResponse request returning *GetTokenForGatewayInNamespaceResponse
func (c *ClientWithResponses) GetTokenForGatewayInNamespaceWithResponse(ctx context.Context, namespace string, name string, id string, reqEditors ...RequestEditorFn) (*GetTokenForGatewayInNamespaceResponse, error) {
	rsp, err := c.GetTokenForGatewayInNamespace(ctx, namespace, name, id, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetTokenForGatewayInNamespaceResponse(rsp)
}
...
// ParseCreateTokenForGatewayResponse parses an HTTP response from a CreateTokenForGatewayWithResponse call
func ParseCreateTokenForGatewayResponse(rsp *http.Response) (*CreateTokenForGatewayResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &CreateTokenForGatewayResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseDeleteTokenForGatewayResponse parses an HTTP response from a DeleteTokenForGatewayWithResponse call
func ParseDeleteTokenForGatewayResponse(rsp *http.Response) (*DeleteTokenForGatewayResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &DeleteTokenForGatewayResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseGetTokenForGatewayResponse parses an HTTP response from a GetTokenForGatewayWithResponse call
func ParseGetTokenForGatewayResponse(rsp *http.Response) (*GetTokenForGatewayResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetTokenForGatewayResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseCreateTokenForGatewayInNamespaceResponse parses an HTTP response from a CreateTokenForGatewayInNamespaceWithResponse call
func ParseCreateTokenForGatewayInNamespaceResponse(rsp *http.Response) (*CreateTokenForGatewayInNamespaceResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &CreateTokenForGatewayInNamespaceResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseDeleteTokenForGatewayInNamespaceResponse parses an HTTP response from a DeleteTokenForGatewayInNamespaceWithResponse call
func ParseDeleteTokenForGatewayInNamespaceResponse(rsp *http.Response) (*DeleteTokenForGatewayInNamespaceResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &DeleteTokenForGatewayInNamespaceResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseGetTokenForGatewayInNamespaceResponse parses an HTTP response from a GetTokenForGatewayInNamespaceWithResponse call
func ParseGetTokenForGatewayInNamespaceResponse(rsp *http.Response) (*GetTokenForGatewayInNamespaceResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetTokenForGatewayInNamespaceResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
type ServerInterface interface {
	...
	// (POST /gateways/{name}/tokens)
	CreateTokenForGateway(w http.ResponseWriter, r *http.Request, name string)

	// (DELETE /gateways/{name}/tokens/{id})
	DeleteTokenForGateway(w http.ResponseWriter, r *http.Request, name string, id string)

	// (GET /gateways/{name}/tokens/{id})
	GetTokenForGateway(w http.ResponseWriter, r *http.Request, name string, id string)
	...
	// (POST /namespaces/{namespace}/gateways/{name}/tokens)
	CreateTokenForGatewayInNamespace(w http.ResponseWriter, r *http.Request, namespace string, name string)

	// (DELETE /namespaces/{namespace}/gateways/{name}/tokens/{id})
	DeleteTokenForGatewayInNamespace(w http.ResponseWriter, r *http.Request, namespace string, name string, id string)

	// (GET /namespaces/{namespace}/gateways/{name}/tokens/{id})
	GetTokenForGatewayInNamespace(w http.ResponseWriter, r *http.Request, namespace string, name string, id string)
...
// CreateTokenForGateway operation middleware
func (siw *ServerInterfaceWrapper) CreateTokenForGateway(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateTokenForGateway(w, r, name)
	})
...
// DeleteTokenForGateway operation middleware
func (siw *ServerInterfaceWrapper) DeleteTokenForGateway(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DeleteTokenForGateway(w, r, name, id)
	})
...
// GetTokenForGateway operation middleware
func (siw *ServerInterfaceWrapper) GetTokenForGateway(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetTokenForGateway(w, r, name, id)
	})
...
// CreateTokenForGatewayInNamespace operation middleware
func (siw *ServerInterfaceWrapper) CreateTokenForGatewayInNamespace(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateTokenForGatewayInNamespace(w, r, namespace, name)
	})
...
// DeleteTokenForGatewayInNamespace operation middleware
func (siw *ServerInterfaceWrapper) DeleteTokenForGatewayInNamespace(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DeleteTokenForGatewayInNamespace(w, r, namespace, name, id)
	})
...
// GetTokenForGatewayInNamespace operation middleware
func (siw *ServerInterfaceWrapper) GetTokenForGatewayInNamespace(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetTokenForGatewayInNamespace(w, r, namespace, name, id)
	})
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/gateways/{name}/tokens", wrapper.CreateTokenForGateway)
	})
	r.Group(func(r chi.Router) {
		r.Delete(options.BaseURL+"/gateways/{name}/tokens/{id}", wrapper.DeleteTokenForGateway)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/gateways/{name}/tokens/{id}", wrapper.GetTokenForGateway)
	})
	r.Group(func(r chi.Router) {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/namespaces/{namespace}/gateways/{name}/tokens", wrapper.CreateTokenForGatewayInNamespace)
	})
	r.Group(func(r chi.Router) {
		r.Delete(options.BaseURL+"/namespaces/{namespace}/gateways/{name}/tokens/{id}", wrapper.DeleteTokenForGatewayInNamespace)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"