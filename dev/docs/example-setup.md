...
```bash
kubectl apply -k "github.com/hashicorp/consul-api-gateway/config/crd?ref=v0.5.5"
kubectl apply -k "github.com/hashicorp/consul-api-gateway/config?ref=v0.5.5"
```
...
resources:
- github.com/hashicorp/consul-api-gateway/config/example?ref=v0.5.5
